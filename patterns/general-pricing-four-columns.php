 ...
 * Slug: uniblock/general-pricing-four-columns
...
<div class="wp-block-button"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Sign Up Now', 'uniblock' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
