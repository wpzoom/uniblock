 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"40px","bottom":"40px"},"margin":{"top":"0px"}},"elements":{"link":{"color":{"text":"var:preset|color|white"}}}},"backgroundColor":"header-footer","textColor":"white","className":"is-style-default","layout":{"inherit":true},"fontSize":"small"} -->
...
<h2 class="has-tertiary-color has-text-color" style="margin-bottom:var:preset|spacing|50">UNIBLOCK</h2>
<!-- /wp:heading -->
...
<h3 class="has-tertiary-color has-text-color has-small-font-size" style="margin-bottom:var:preset|spacing|50">Company</h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"textColor":"tertiary","fontSize":"small"} -->
<h3 class="has-tertiary-color has-text-color has-small-font-size" style="margin-bottom:var:preset|spacing|50">Legal</h3>
<!-- /wp:heading -->
...
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:heading {"level":3,"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50"}}},"textColor":"tertiary","fontSize":"small"} -->
<h3 class="has-tertiary-color has-text-color has-small-font-size" style="margin-bottom:var:preset|spacing|50">Subscribe to our Newsletter</h3>
<!-- /wp:heading -->
