 ...
 * Slug: uniblock/general-pricing-four-columns-main-background
...
<h2 class="has-text-align-center has-x-large-font-size" id="pricing-table"><?php echo esc_html__( 'Pricing Table', 'uniblock' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'Create a four-column table, wide-width', 'uniblock' ); ?> (1200px).</p>
<!-- /wp:paragraph -->
...
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Personal', 'uniblock' ); ?> - $95</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Feature Item', 'uniblock' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-foreground-color has-background-background-color has-text-color has-background"><?php echo esc_html__( 'Sign Up Now', 'uniblock' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-group has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Professional', 'uniblock' ); ?> - $295</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"background"} -->
...
<div class="wp-block-group has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Enterprise', 'uniblock' ); ?> - $495</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"background"} -->
...
<div class="wp-block-group has-foreground-color has-background-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Ultimate', 'uniblock' ); ?> - $995</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"40px","right":"40px","bottom":"40px","left":"40px"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"background"} -->
