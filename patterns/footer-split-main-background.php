 ...
 * Slug: uniblock/footer-split-main-background
 * Categories: uniblock-footer
 * Block Types: core/template-part/footer
 * Viewport Width: 1280
 */
?>
<!-- wp:group {"align":"full","style":{"elements":{"link":{"color":{"text":"var:preset|color|background"}}},"spacing":{"padding":{"top":"40vh","bottom":"40px"},"margin":{"top":"0px"}}},"backgroundColor":"foreground","textColor":"background","layout":{"type":"constrained"},"fontSize":"small"} -->
...
<p class="has-max-48-font-size" id="design-with-courage" style="line-height:1.25"><?php echo esc_html__( 'Design with courage.', 'uniblock' ); ?></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:column -->
...
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Start Here', 'uniblock' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Our Services', 'uniblock' ); ?></a></p>
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Contact Us', 'uniblock' ); ?></a></p>
<!-- /wp:paragraph -->
</div>
<!-- /wp:group -->
</div>
