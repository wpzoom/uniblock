 ...
 * Slug: uniblock/general-hero-three-columns-main-background
...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button"><?php echo esc_html__( 'Image, heading, text, button.', 'uniblock' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample-white_1200x1200.jpg'; ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'uniblock' ); ?>" class="wp-image-242"/></figure>
<!-- /wp:image -->
