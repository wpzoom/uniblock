...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:heading {"level":1,"textColor":"white","fontSize":"max-48"} -->
<h1 class="has-white-color has-text-color has-max-48-font-size">Talk to us</h1>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Maecenas sed diam eget risus varius blandit sit amet non magna. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit.</p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%"><!-- wp:image {"align":"right","id":5753,"sizeSlug":"large","linkDestination":"none","style":{"color":{}}} -->
<figure class="wp-block-image alignright size-large"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>Rectangle-24-1.png" alt="" class="wp-image-5753"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
<!-- /wp:group --></main>
...
<h2 class="has-max-48-font-size">We’re happy to discuss your needs!</h2>
<!-- /wp:heading -->
...
<!-- wp:column {"verticalAlignment":"center","width":"50%","style":{"spacing":{"padding":{"left":"var:preset|spacing|small","top":"var:preset|spacing|small","bottom":"var:preset|spacing|small","right":"var:preset|spacing|small"}}},"layout":{"type":"default"}} -->
<div class="wp-block-column is-vertically-aligned-center" style="padding-top:var(--wp--preset--spacing--small);padding-right:var(--wp--preset--spacing--small);padding-bottom:var(--wp--preset--spacing--small);padding-left:var(--wp--preset--spacing--small);flex-basis:50%"><!-- wp:heading {"fontSize":"max-48"} -->
...
<h2 class="has-text-align-left has-max-48-font-size">Our Locations</h2>
<!-- /wp:heading -->
