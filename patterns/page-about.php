...
<!-- wp:heading {"level":1,"align":"wide","textColor":"white","fontSize":"max-48"} -->
<h1 class="alignwide has-white-color has-text-color has-max-48-font-size">We help companies build <br>great solutions</h1>
<!-- /wp:heading -->
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"50%","style":{"spacing":{"padding":{"right":"var:preset|spacing|80"}}},"layout":{"type":"default"}} -->
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--80);flex-basis:50%"><!-- wp:paragraph {"textColor":"primary"} -->
<p class="has-primary-color has-text-color">OUR STORY  </p>
<!-- /wp:paragraph -->
...
<div class="wp-block-column is-style-default" style="border-style:none;border-width:0px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:group {"layout":{"type":"constrained"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}},"border":{"radius":"20px"}},"backgroundColor":"white","className":"is-style-border"} -->
<div class="wp-block-group is-style-border has-white-background-color has-background" style="border-radius:20px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:spacer {"height":"44px"} -->
...
<!-- wp:group {"layout":{"type":"constrained"},"style":{"spacing":{"padding":{"top":"var:preset|spacing|40","right":"var:preset|spacing|40","bottom":"var:preset|spacing|40","left":"var:preset|spacing|40"}},"border":{"radius":"20px"}},"backgroundColor":"white","className":"is-style-border"} -->
<div class="wp-block-group is-style-border has-white-background-color has-background" style="border-radius:20px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)"><!-- wp:spacer {"height":"44px"} -->
<div style="height:44px" aria-hidden="true" class="wp-block-spacer"></div>
<!-- /wp:spacer -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Partners around the World</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Offices in different countries</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:group {"layout":{"type":"default"},"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","left":"0","bottom":"var:preset|spacing|80"}}},"backgroundColor":"white","className":"is-style-default"} -->
<div class="wp-block-group alignfull is-style-default has-white-background-color has-background" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:0"><!-- wp:group {"layout":{"type":"constrained"},"align":"wide"} -->
<div class="wp-block-group alignwide"><!-- wp:columns {"align":"wide","style":{"spacing":{"padding":{"top":"0","right":"0","bottom":"0","left":"0"}}}} -->
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"verticalAlignment":"top","width":"50%","layout":{"type":"default"}} -->
...
<figure class="wp-block-image alignright size-large"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/'; ?>Group-4.png" alt="" class="wp-image-5631"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->

<!-- wp:column {"width":"50%","style":{"spacing":{"padding":{"left":"var:preset|spacing|80"}}},"layout":{"type":"default"}} -->
<div class="wp-block-column" style="padding-left:var(--wp--preset--spacing--80);flex-basis:50%"><!-- wp:paragraph {"textColor":"primary"} -->
<p class="has-primary-color has-text-color">OUR EXPERTISE</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"fontSize":"max-48"} -->
<h2 class="has-max-48-font-size">Duis aute irure dolor reprehenderit</h2>
<!-- /wp:heading -->
...
<p class="has-text-align-center has-primary-color has-text-color">WHAT WE DO</p>
<!-- /wp:paragraph -->

<!-- wp:heading {"textAlign":"center","fontSize":"max-48"} -->
<h2 class="has-text-align-center has-max-48-font-size">Bring the world to <br>your solutions</h2>
<!-- /wp:heading -->
...
<!-- wp:heading {"fontSize":"max-48"} -->
<h2 class="has-max-48-font-size">We are friendly <br>and collaborative</h2>
<!-- /wp:heading -->
...
<h2 class="has-text-align-left has-max-48-font-size">Our Location</h2>
<!-- /wp:heading -->
